...
<style>
/* Add a CSS style block to apply styles */
#selectedType {
    font-size: 16px; /* Adjust the font size to make it slightly bigger */
}
...
<form name="fboardlist" id="fboardlist" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">

<h1 style="font-weight: bold;">Filter By</h1> <br><br>

<button type="button" class="collapsible" onclick="collapse(this);">Type</button>
<div class="content">
    <p>ccjcjc</p>
    <select style="width: 20%;" name="selectedType" id="selectedType">
...
<button type="button" class="collapsible" onclick="collapse(this);">Industry</button>
<div class="content">
    <select style="width: 20%;" name="selectedType" id="selectedType">
...
<button type="button" class="collapsible" onclick="collapse(this);">Sensor</button>
<div class="content">
    <select style="width: 20%;" name="selectedType" id="selectedType">
