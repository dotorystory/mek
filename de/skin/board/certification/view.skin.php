...
<article id="bo_v" style="width:<?php echo $width; ?>" class="sub-container">
  <section id="bo_v_info">
    ...
    <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;">Delete <i class="fas fa-trash-alt"></i></a></li><?php } ?>
    ...
    <?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" onclick="board_move(this.href); return false;">Move <i class="fas fa-arrows-alt"></i></a></li><?php } ?>
