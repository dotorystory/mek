...
<div id="bo_gall" style="width:<?php echo $width; ?>" class="sub-container">
  ...
  <?php echo $page ?> page
        ...
        <ul class="btn_bo_user">
            ...
            <li>
                <button type="button" class="btn_bo_sch btn_b01 btn" title="Board Search"><i class="ri-search-line"></i> <span class="sound_only">Board Search</span></button>
            </li>
            ...
            <?php if ($is_admin == 'super' || $is_auth) {  ?>
              <li>
      <button type="button" class="btn_more_opt is_list_btn btn_b01 btn" title="Board List Options"><i class="ri-menu-line"></i><span class="sound_only">Board List Options</span></button>
      <?php if ($is_checkbox) { ?>
      <ul class="more_opt is_list_btn">
          <li><button type="submit" name="btn_submit" value="DeleteSelected" onclick="document.pressed=this.value"><i class="ri-delete-bin-line"></i> Delete Selected</button></li>
          <li><button type="submit" name="btn_submit" value="CopySelected" onclick="document.pressed=this.value"><i class="ri-file-copy-line"></i> Copy Selected</button></li>
          <li><button type="submit" name="btn_submit" value="MoveSelected" onclick="document.pressed=this.value"><i class="ri-share-forward-box-line"></i> Move Selected</button></li>
      </ul>
      <?php } ?>
  </li>
...
;
    ...
    <div id="gall_allchk" class="all_chk chk_box">
        ...
        <label for="chkall">
            <span></span>
            <b class="sound_only">현재 페이지 게시물 </b> Select All
        </label>
    </div>
    <?php } ?>
    ...
    <ul id="gall_ul" class="gall_row">
                ...
                <div class="gall_con">
                    <div class="gall_img" style="<?php if ($board['bo_gallery_height'] > 0) echo 'height:'.$board['bo_gallery_height'].'px;max-height:'.$board['bo_gallery_height'].'px'; ?>">
                      ...
                      if($thumb['src']) {
                        ...
                        $img_content = '<i>There are no product images.</i>';
                        }
                      echo $img_content;
                      ?>
                      </a>
                      ...
                      if ($list[$i]['is_notice']) // notice
                        echo '<strong class="notice_icon">ⓘ<span class="sound_only">Notice</span></strong>';
        ...
        <?php } ?>
        <?php if (count($list) == 0) { echo "<li class=\"empty_list\">No products have been registered.</li>"; } ?>
      ...
      <?php if ($list_href || $write_href) { ?>
            <div class="button fl">
                ...
                <span class="bt bt_adm">
                    ...
                    <label for="chkall"><?php echo _("Select All") ?></label>
                </span>
                <button type="submit" name="btn_submit" value="DeleteSelected" onclick="document.pressed=this.value" class="bt bt_adm"><i class="ri-delete-bin-line"></i> <?php echo _("Delete Selected") ?></button>
<button type="submit" name="btn_submit" value="CopySelected" onclick="document.pressed=this.value" class="bt bt_adm"><i class="ri-file-copy-line"></i> <?php echo _("Copy Selected") ?></button>
<button type="submit" name="btn_submit" value="MoveSelected" onclick="document.pressed=this.value" class="bt bt_adm"><i class="ri-share-forward-box-line"></i> <?php echo _("Move Selected") ?></button>

                <?php } ?>
            </div>
            <div class="button fr">
    <?php if ($admin_href) { ?><a href="<?php echo $admin_href ?>" class="bt bt_adm"><i class="ri-user-settings-fill"></i> <?php echo _("Administrator") ?></a><?php } ?>
    <?php if ($rss_href) { ?><a href="<?php echo $rss_href ?>" class="bt bt_b01"><?php echo _("RSS") ?></a><?php } ?>
    <?php if ($list_href) { ?><a href="<?php echo $list_href ?>" class="bt bt_b01"><i class="ri-menu-line"></i> <?php echo _("LIST") ?></a><?php } ?>
    ...
    <fieldset class="bo_sch">
        ...
        <form name="fsearch" method="get">
            ...
            <div class="sch_bar">
                <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="sch_input" size="25" maxlength="20" placeholder="Enter your search keyword">
