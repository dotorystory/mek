	        ...
	        <ul class="btn_bo_user bo_v_com">
	        	...
	        	<li>
		        	...
		        	<ul class="more_opt is_view_btn">
			            ...
			            <?php if ($copy_href) { ?><li><a href="<?php echo $copy_href ?>" onclick="board_move(this.href); return false;">복사<i class="fa fa-copy" aria-hidden="true"></i></a></li><?php } ?>
			            <?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" onclick="board_move(this.href); return false;">이동<i class="fa fa-play" aria-hidden="true"></i></a></li><?php } ?>
...
;
    ...
    <section id="bo_v_atc">
        ...
        <div class="if_date">등록 [ <?php echo date("20y-m-d H:i", strtotime($view['wr_datetime'])) ?> ] </div>
        <!-- 본문 내용 시작 { -->
