...
<header id="header" <?php if(!defined('_INDEX_')){echo "class=\"sub-hd\"";}?>>
  <div class="header_wrap">
    ...
    <div class="head_nav global_nav">
      <ul class="head_gnb">
        <li class="global"><a href="#"><img src="/public/img/icon/de.png" alt="German"></a>
          <ul class="country">
  ...
  <div class="sitemap">
    <div class="sitemap_left">
      ...
      <div class="site_left_txt">
        <h2 class="container">Spezialist für Web-Qualitätsmanagementsysteme,<br>MEK Inc. & MEK Engineering Corp.</h2>
        <p class="container">Ihr technischer Partner<br>für WEB-Anwendungen</p>
      </div>
