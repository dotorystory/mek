...
<div id="sub_wrap" class="sub04_03">
  <section class="sub-section section01 sub-container" data-aos="fade-up"  data-aos-duration="2000">
    <div class="send_box02">
      <fieldset>
        <form name="contactform" method="post" action="/de/sub04_03_send.php" enctype="multipart/form-data" class="fields">
          <ul>
            ...
            <li id="equipment_area">
              <span id="equipment" class="lbl required">Anfragegerät</span>
              <div class="desc flex">
                <input name="group[]" type="checkbox" id="webcleaner" class="input check full" value="Online-Dickenmessgerät">Online-Dickenmessgerät
                <input name="group[]" type="checkbox" id="surface" class="input check full" value="Oberflächenfehlerinspektor">Oberflächenfehlerinspektor
                <input name="group[]" type="checkbox" id="etc_chk" class="input check full"  value="Sonstiges (Direkte Eingabe)">Sonstiges (Direkte Eingabe)
          ...
          <li>
            <label for="phone" class="lbl">Telefonnummer (Festnetz)</label>
            <div class="desc">
            <input name="phone" type="tel" class="input full" id="phone" maxlength="30" placeholder="Geben Sie Ihre Telefonnummer ein">
            </div>
          </li>
          <li>
            <label for="cell" class="lbl required">Mobiltelefon</label>
            <div class="desc">
              <input name="cell" type="tel" class="input full" id="cell" maxlength="80" required placeholder="Geben Sie Ihre Handynummer ein">
            </div>
          </li>
            <li>
              <label for="date" class="lbl required">Kaufdatum</label>
              <div class="desc">
                <input name="date" type="text" class="input full" id="date" maxlength="80" required placeholder="Geben Sie das Kaufdatum ein">
              </div>
            </li>
            <li>
              <label for="process" class="lbl">Angewandter Prozess</label>
              <div class="desc">
                <input name="process" type="text" class="input full" id="process" maxlength="80" placeholder="z.B. Extrusion, Beschichtung">
              </div>
            </li>
              <li>
                <label for="thickness" class="lbl">Messdicke</label>
                <div class="desc">
                  <input name="thickness" type="text" class="input full" id="thickness" maxlength="80" >
                </div>
              </li>
              <li>
                <label for="width" class="lbl">Messbreite</label>
                <div class="desc">
            ...
            <li>
              <label for="comments" class="lbl">A/S Anfragenachricht</label>
              <div class="desc">
              <textarea type="text" class="input full" name="comments" id="comments" rows="10" cols="80" placeholder="Bitte fügen Sie Fotos vor Ort und Fremdmaterialtypen separat bei"></textarea>
              </div>
            </li>
            <li>
            ...
            <li>
              <label class="lbl">Spam-Schutz (CAPTCHA)</label>
              <div class="desc">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    contactForm.addEventListener("submit", function(e) {
        if (!isAnyCheckboxChecked()) {
            ...
            equipmentMessageSpan.innerHTML = "<br>* Überprüfen Sie das Anfragegerät.";  // Show the error message
        } else {
