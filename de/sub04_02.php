...
<div id="sub_wrap" class="sub04_02">
  <section class="sub-section section01 sub-container" data-aos="fade-up"  data-aos-duration="2000">
    ...
    <div class="send_box02">
      <fieldset>
        <form name="contactform" method="post" action="/de/sub04_02_send.php" enctype="multipart/form-data" class="fields">
          <ul>
            ...
            <li id="equipment_area">
              ...
              <div class="desc flex ">
                <input name="group[]" type="checkbox" id="online" class="input full check" value="Online-Dickenmessgerät">Online-Dickenmessgerät
                <input name="group[]" type="checkbox" id="offline" class="input full check" value="Offline-Dickenmessgerät">Offline-Dickenmessgerät
              </div>
            </li>
            <li>
            ...
            <li>
              ...
              <li id="apc_area">
                <span id="apply_apc" class="lbl">APC-Anwendung</span>
                <div class="desc flex">
                  <input name="apc[]" type="checkbox" id="apcOn" class="input full check" value="APC angewandt">APC angewandt
                  <input name="apc[]" type="checkbox" id="apcOff" class="input full check" value="APC nicht angewandt">APC nicht angewandt
                </div>
              </li>
              <li id="line_area">
                <span id="line_status" class="lbl">Linienstatus</span>
                <div class="desc flex">
                  <input name="lineStatus[]" type="checkbox" id="lineNew" class="input full check" value="Neue Linie">Neue Linie
                  <input name="lineStatus[]" type="checkbox" id="lineExisting" class="input full check" value="Bestehende Linie">Bestehende Linie
                </div>
              </li>
            </div>
