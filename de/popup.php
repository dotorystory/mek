    ...
    <div class="popup_content">
        ...
        <div class="popup_footer">
            <div class="popup_checkbox_wrap">
                ...
                <label for="popup_close_today" class="popup_checkbox_label">Heute nicht erscheinen</label>
            </div>
            <div class="popup_buttons">
                <button type="button" class="popup_close_btn" onclick="closePopupWithOption()">Schließen</button>
            </div>
        </div>
    </div>
</div>
