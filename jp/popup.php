...
<div id="popup_layer" class="popup_layer">
    <div class="popup_content">
        ...
        <div class="popup_image_container">
            <img src="<?php echo G5_IMG_URL; ?>/popup.png" alt="ポップアップ画像" class="popup_image">
        </div>
        
        <div class="popup_footer">
            <div class="popup_checkbox_wrap">
                <input type="checkbox" id="popup_close_today" class="popup_checkbox">
                <label for="popup_close_today" class="popup_checkbox_label">今日は表示しない</label>
            </div>
            <div class="popup_buttons">
                <button type="button" class="popup_close_btn" onclick="closePopupWithOption()">閉じる</button>
            </div>
        </div>
    </div>
</div>
