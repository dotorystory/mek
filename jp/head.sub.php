...
<title><?php echo $config['cf_title']; ?></title>
  ...
  <meta name="description" content="MEKエンジニアリング：ウェブプロセス測定・制御システムの世界的リーダー。厚み測定、APC、二次電池・フィルムの品質ソリューションに特化。">
  <meta name="keywords" content="MEK, エンジニアリング, 厚み測定器, 質量測定器, 密度測定器, 厚み測定, ウェブプロセス制御, 二次電池, リチウム電池, ロールtoロール, スマートファクトリー">
  ...
  <meta property="og:title" content="MEK | 厚み測定システムの世界的リーダー">
  <meta property="og:site_name" content="MEK Engineering Corporation">
  <meta property="og:description" content="厚み・密度・質量測定の革新。MEKの超精密測定システムは二次電池、フィルム、金属産業の品質と生産性を最大化します。">
  ...
  <meta name="twitter:title" content="MEK | ウェブプロセス測定・制御システム">
  <meta name="twitter:description" content="ウェブプロセス測定・制御システムの世界的リーダー。">
