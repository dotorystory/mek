...
if(isset($_POST['email'])) {
  ...
  $email_message .= "APC適用可否 : ".(!empty($apc) ? clean_string($apc) : 'なし')."<br><br>"; //선택항목
  $email_message .= "ライン状態 : ".(!empty($lineStatus) ? clean_string($lineStatus) : 'なし')."<br><br>"; //선택항목
