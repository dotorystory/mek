...
function get_board_sfl_select_options($sfl){
    ...
    $str = '';
    $str .= '<option value="wr_subject" '.get_selected($sfl, 'wr_subject', true).'>題名</option>';
    $str .= '<option value="wr_content" '.get_selected($sfl, 'wr_content').'>内容</option>';
    $str .= '<option value="wr_subject||wr_content" '.get_selected($sfl, 'wr_subject||wr_content').'>題名+内容</option>';
    if ( $is_admin ){
        $str .= '<option value="mb_id,1" '.get_selected($sfl, 'mb_id,1').'>会員ID</option>';
        $str .= '<option value="mb_id,0" '.get_selected($sfl, 'mb_id,0').'>会員ID(co)</option>';
    }
    $str .= '<option value="wr_name,1" '.get_selected($sfl, 'wr_name,1').'>著者</option>';
    $str .= '<option value="wr_name,0" '.get_selected($sfl, 'wr_name,0').'>著者(co)</option>';
