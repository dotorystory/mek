...
if(isset($_POST['email'])) {
  ...
  $email_message .= "問い合わせ設備 : ".clean_string($group)."<br><br>"; //필수항목
  ...
  $email_message .= "電話番号（有線） : ".clean_string($phone)."<br><br>";
  $email_message .= "携帯電話 : ".clean_string($cell)."<br><br>";
  $email_message .= "購入時期 : ".clean_string($date)."<br><br>";
  $email_message .= "適用工程 : ".clean_string($process)."<br><br>";
  $email_message .= "測定厚さ : ".clean_string($thickness)."<br><br>";
  $email_message .= "測定幅 : ".clean_string($width)."<br><br>";
  $email_message .= "A/S問い合わせ内容 : ".clean_string(nl2br($comments))."<br><br>";
