...
<header id="header" <?php if(!defined('_INDEX_')){echo "class=\"sub-hd\"";}?>>
  <div class="header_wrap">
    ...
    <div class="head_nav global_nav">
      <ul class="head_gnb">
        <li class="global"><a href="#"><img src="/public/img/icon/jp.png" alt="Japan"></a>
          <ul class="country">
  ...
  <div class="sitemap">
    <div class="sitemap_left">
      ...
      <div class="site_left_txt">
        <h2 class="container">ウェブ品質管理システムの専門企業、<br>MEK & メックエンジニアリング(MEK)</h2>
        <p class="container">あなたのテクノロジーパートナー<br>WEB申請の場合</p>
      </div>
      <div class="site_left_add container">
        <p>仁川広域市 扶平区 扶平大路 313番道路 30<br>
          <small>著作権(c) MEKエンジニアリングコーポレーション & 株式会社MEK。全著作権所有。</small></p>
      </div>
    </div>
...
<?php include_once(G5_PATH.'/menu.json.php');?>
<?php if($bo_table == "history_jp") { $menuCodeParent = 0; $menuCodeChild = 1;}
      else if($bo_table == "partner_jp") { $menuCodeParent = 0; $menuCodeChild = 2;}
      else if($bo_table == "certif_jp") { $menuCodeParent = 0; $menuCodeChild = 3;}
      else if($bo_table == "patent_jp") { $menuCodeParent = 0; $menuCodeChild = 3;}
      else if($bo_table == "license_jp") { $menuCodeParent = 0; $menuCodeChild = 3;}
      else if($bo_table == "pro_jp") { $menuCodeParent = 2; $menuCodeChild = 0;}
      else if($bo_table == "pro02_jp") { $menuCodeParent = 2; $menuCodeChild = 1;}
      else if($bo_table == "pro03_jp") { $menuCodeParent = 2; $menuCodeChild = 2;}
      else if($bo_table == "pro04_jp") { $menuCodeParent = 2; $menuCodeChild = 3;}
      else if($bo_table == "catalog_jp") { $menuCodeParent = 3; $menuCodeChild = 0;}
      else if($bo_table == "news_jp") { $menuCodeParent = 4; $menuCodeChild = 3;}
