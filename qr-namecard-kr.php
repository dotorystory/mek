...
$utm_source = isset($_GET['utm_source']) ? $_GET['utm_source'] : "kr_namecard_qr";
$utm_medium = isset($_GET['utm_medium']) ? $_GET['utm_medium'] : "qr_code";
$utm_campaign = isset($_GET['utm_campaign']) ? $_GET['utm_campaign'] : "namecard_kr";
...
// 국가별 리다이렉트 경로 설정 (명함 QR: 한국어 기본)
$langPath = "/home"; // 기본값: 한국어
