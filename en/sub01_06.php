...
<div id="sub_wrap" class="sub01_06">
  ...
  <section class="sub-section section02 sub-container" data-aos="fade-up"  data-aos-duration="2000">
    <div class="sub_content_tit">
      <span data-split="Research Fields"></span>
      <h5>Research Fields</h5>
    </div>
    <ul>
      <li><p><span class="overview_tit">New Product Development</span></p>
        <p><i class="ri-survey-line"></i></p></li>
      <li><p><span class="overview_tit">AI Control System Development</span></p><p><i class="ri-settings-2-line"></i></p></li>
      <li><p><span class="overview_tit">New Sensor Development</span></p><p><i class="ri-lightbulb-flash-line"></i></p></li>
    </ul>
  </section>

  <section class="sub-section section03 sub-container" data-aos="fade-up"  data-aos-duration="2000">
    <div class="sub_content_tit">
      <span data-split="Research Organization"></span>
      <h5>Research Organization</h5>
    </div>
  ...
  <section class="sub-section section04 sub-container" data-aos="fade-up"  data-aos-duration="2000">
    <div class="sub_content_tit">
      <span data-split="Research Equipment"></span>
      <h5>Research Equipment</h5>
    </div>
    <div class="flex_wrap">
      <ul>
