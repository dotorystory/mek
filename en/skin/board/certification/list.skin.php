...
<div id="bo_gall" style="width:<?php echo $width; ?>" class="sub-container">
    ...
    <div id="bo_btn_top">
      ...
      <li><button type="submit" name="btn_submit" value="Delete Selected" onclick="document.pressed=this.value"><i class="fas fa-trash-alt"></i> Delete Selected</button></li>
      ...
      <li><button type="submit" name="btn_submit" value="Move Selected" onclick="document.pressed=this.value"><i class="fas fa-arrows-alt"></i> Move Selected</button></li>
  </ul>
