...
if(isset($_POST['email'])) {
  ...
  $email_subject = "[Thickness Gauge Product Inquiry]";
  ...
  $email_message .= "APC Application : ".(!empty($apc) ? clean_string($apc) : 'None')."<br><br>"; //선택항목
  $email_message .= "Line Status : ".(!empty($lineStatus) ? clean_string($lineStatus) : 'None')."<br><br>"; //선택항목
