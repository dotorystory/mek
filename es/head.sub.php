...
<title><?php echo $config['cf_title']; ?></title>
  <link rel="canonical" href="https://www.mekeng.com/es/">

  <!-- SEO -->
  <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
  <meta name="description" content="MEK Engineering Corporation: Líder global en sistemas de medición y control de procesos web. Especialistas en medición de espesor, APC y soluciones de calidad para baterías secundarias y películas.">
  <meta name="keywords" content="medidor de espesor, medidor de densidad, medidor de masa, sistema de medición de espesor, control de proceso web, batería secundaria, batería de litio, batería de iones de litio, medición en línea, control de calidad, rollo a rollo, fábrica inteligente, APC, sistema de control avanzado, película delgada, industria de baterías, medición de espesor en tiempo real, control de proceso industrial, MEK Engineering">

  <!-- 회사 정보 -->
  <meta name="author" content="MEK Engineering Corporation">
  <meta name="copyright" content="© 2025 MEK Engineering Corporation. Todos los derechos reservados.">
  ...
  <meta property="og:url" content="https://www.mekeng.com/es/">
  <meta property="og:title" content="MEK | Líder Global en Sistemas de Medición de Espesor">
  <meta property="og:site_name" content="MEK Engineering Corporation">
  <meta property="og:description" content="Revolución en la medición de espesor, densidad y masa. Los sistemas de medición de ultra precisión de MEK maximizan la calidad y productividad en las industrias de baterías secundarias, películas y metales.">
  ...
  <meta name="twitter:title" content="MEK | Sistemas de Medición y Control de Proceso Web">
  <meta name="twitter:description" content="Líder global en sistemas de medición y control de procesos web para baterías, películas y metales.">
