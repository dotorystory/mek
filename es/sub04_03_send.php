...
if(isset($_POST['email'])) {
  ...
  if (!chk_captcha()) {
    echo "<script> alert('El código de seguridad es incorrecto.');";
    echo "history.go(-1);";
    echo "</script>";
    die();
  }
  ...
  $email_message .= "Inquiry Equipment : ".clean_string($group)."<br><br>"; //필수항목
  ...
  $email_message .= "Phone Number (Landline) : ".clean_string($phone)."<br><br>";
  $email_message .= "Mobile Phone : ".clean_string($cell)."<br><br>";
  $email_message .= "Purchase Date : ".clean_string($date)."<br><br>";
  $email_message .= "Applied Process : ".clean_string($process)."<br><br>";
  $email_message .= "Measurement Thickness : ".clean_string($thickness)."<br><br>";
  $email_message .= "Measurement Width : ".clean_string($width)."<br><br>";
  $email_message .= "A/S Inquiry Message : ".clean_string(nl2br($comments))."<br><br>";
