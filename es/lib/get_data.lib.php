...
function get_board_sfl_select_options($sfl){
    ...
    $str = '';
    $str .= '<option value="wr_subject" '.get_selected($sfl, 'wr_subject', true).'>Subject</option>';
    $str .= '<option value="wr_content" '.get_selected($sfl, 'wr_content').'>Content</option>';
    $str .= '<option value="wr_subject||wr_content" '.get_selected($sfl, 'wr_subject||wr_content').'>Subject+Content</option>';
    if ( $is_admin ){
        $str .= '<option value="mb_id,1" '.get_selected($sfl, 'mb_id,1').'>Member ID</option>';
        $str .= '<option value="mb_id,0" '.get_selected($sfl, 'mb_id,0').'>Member ID (Code)</option>';
    }
    $str .= '<option value="wr_name,1" '.get_selected($sfl, 'wr_name,1').'>Writer</option>';
    $str .= '<option value="wr_name,0" '.get_selected($sfl, 'wr_name,0').'>Writer (Code)</option>';
