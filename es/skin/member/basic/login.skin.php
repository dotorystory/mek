...
<div id="mb_login" class="mbskin">
    <a href="<?php echo G5_URL ?>/" style="display: block; text-align: center; margin: 20px auto; max-width: 70%;">     
        <img src="/public/img/logo-3d.png" alt="MEK Logo">
        <p style="font-size: 1.3em; color: #333;">스페인어 사이트</p>
    </a>
