...
<div class="page_anchor_wrap carousel">
  ...
  <div class="scroll-down">
      <p class="scroll-txt">Desplazar hacia abajo</p>
            ...
            <div class="main-container">
              <div class="vi_txt_po">
                <div class="vi_txt_wrap">
                  ...
                  <p class="vi_txt">El medidor de espesor en línea MEK es un equipo que mide el espesor <br class="pc">de productos con forma de web. Al medir el espesor de todo el <br class="pc">ancho en tiempo real durante la producción del producto, ayuda a mejorar la calidad,<br class="pc"> optimizar procesos y reducir costos.</p>
    ...
    <section id="main_08" class="main-section section fp-auto-height fp-auto-height-responsive main_partner_section">
      <div class="main_partner">
        <div class="main_partner_wrap">
          ...
          <ul>
            <li><span>1</span><span>Mejora de la calidad del producto - Gestión de desviaciones (Espesor, Peso, Densidad)</span></li>
            <li><span>2</span><span>Mejor programa. Gestión ultra-nano. Sensores personalizados como X, β y láser.</span></li>
            <li><span>3</span><span>Gestión de procesos, optimización con sistemas de monitoreo y control en tiempo real.</span></li>
            <li><span>4</span><span>Mejorar la calidad, reducir pérdidas y mejorar la competitividad de la marca.</span></li>
            <li><span>5</span><span>Dispositivo de clase mundial, personalizado, ¡y la elección de empresas globales!</span></li>
          </ul>
        ...
        <div class="main_product_table">
          ...
          <div class="main_product_wrap">
            ...
            <div class="main_pro_txt" >
              ...
              <p class="main_pro_info">Utilizando un sensor de desplazamiento coaxial, mide el espesor <br class="pc">de recubrimientos positivos/negativos.<br>Minimiza el impacto de vibraciones y cambios de tensión sin <br class="pc">verse afectado por la superficie y la luz reflejada, lo que hace posible <br class="pc">lograr la mejor gestión de espesor en el proceso Roll Press existente.<br><span class="info_small">* Dispositivo de medición de espesor sin contacto / Patente No. 10-1825081</span></p>
        ...
        <div class="main_product_table">
          ...
          <div class="main_product_wrap">
            ...
            <div class="main_pro_txt">
              ...
              <p class="main_pro_info">El medidor de espesor en línea X-Ray y β-RAY de MEK es un equipo <br class="pc">para medir el espesor de productos en el proceso de producción de <br class="pc">Film o Foil. <br>Proporciona mediciones más precisas, contribuyendo a mejorar la <br class="pc">calidad, optimización de procesos y ahorro de costos.</p>
      ...
      <div class="main_partner">
        <div class="main_partner_wrap">
          <div class="main_partner_txt container">
            ...
            <p>Siempre nos esforzamos por crear los mejores productos del mundo con amplia experiencia y la tecnología más reciente, y para satisfacer sus requisitos al máximo.</p>
        ...
        <div class="main_cert_wrap">
          <div class="main_cert_patent main_cert_content up">
            ...
            <div class="main_cert_txt">
              <h3>Patent</h3>
              <p class="main_cert_txt_con">El Centro de I+D de MEK lidera continuamente el avance tecnológico de la industria<br class="pc">a través de una investigación incansable y proporciona los mejores productos.</p>
          ...
          <div class="main_contact_txt">
            ...
            <ul class="main_contact_info">
              ...
              <li>  <h4>Tel</h4>
                ...
                <li><h4>Map</h4>
                  <p class="main_map_link"><a href="https://goo.gl/maps/GZyXpGczz41wA8kp7" target="_blank"><img src="<?php echo G5_IMG_URL?>/icon_google.png" alt="map pin"> <span>Ir a Google Maps</span> <i class="ri-external-link-line"></i></a></p>
                  <p class="main_map_link"><a href="https://naver.me/56DkMkfv" target="_blank"><img src="<?php echo G5_IMG_URL?>/icon_naver.png" alt="map pin"> <span>Ir a Naver Maps</span> <i class="ri-external-link-line"></i></a></p>
                  <p class="main_map_link"><a href="https://kko.to/AJHNDQK_Wu" target="_blank"><img src="<?php echo G5_IMG_URL?>/icon_kakao.png" alt="map pin"> <span>Ir a Kakao Maps</span> <i class="ri-external-link-line"></i></a></p>
