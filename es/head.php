...
<header id="header" <?php if(!defined('_INDEX_')){echo "class=\"sub-hd\"";}?>>
  <div class="header_wrap">
    ...
    <div class="head_nav global_nav">
      <ul class="head_gnb">
        <li class="global"><a href="#"><img src="/public/img/icon/es.png" alt="English"></a>
          <ul class="country">
  ...
  <div class="sitemap">
    <div class="sitemap_left">
      ...
      <div class="site_left_txt">
        <h2 class="container">Empresa especialista en sistemas de gestión de calidad web,<br>MEK Inc. y MEK Engineering Corp.</h2>
        <p class="container">Your Technical Partner<br>For WEB Application</p>
      </div>
      <div class="site_left_add container">
        <p>30, Bupyeong-daero 313beon-gil, <br>Bupyeong-gu, Incheon, República de Corea<br>
          <small>Copyright(c) MEK Engineering Corp. y MEK Inc. Todos los derechos reservados.</small></p>
      </div>
    </div>
...
<?php include_once(G5_PATH.'/menu.json.php');?>
<?php if($bo_table == "history_en") { $menuCodeParent = 0; $menuCodeChild = 1;}
      else if($bo_table == "partner_en") { $menuCodeParent = 0; $menuCodeChild = 2;}
      else if($bo_table == "certif_en") { $menuCodeParent = 0; $menuCodeChild = 3;}
      else if($bo_table == "patent_en") { $menuCodeParent = 0; $menuCodeChild = 3;}
      else if($bo_table == "license_en") { $menuCodeParent = 0; $menuCodeChild = 3;}
      else if($bo_table == "pro_en") { $menuCodeParent = 2; $menuCodeChild = 0;}
      else if($bo_table == "pro02_en") { $menuCodeParent = 2; $menuCodeChild = 1;}
      else if($bo_table == "pro03_en") { $menuCodeParent = 2; $menuCodeChild = 2;}
      else if($bo_table == "pro04_en") { $menuCodeParent = 2; $menuCodeChild = 3;}
      else if($bo_table == "catalog_en") { $menuCodeParent = 3; $menuCodeChild = 0;}
      else if($bo_table == "news_en") { $menuCodeParent = 4; $menuCodeChild = 3;}
