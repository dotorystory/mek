...
define('G5_MYSQL_USER', 'mekeng');
define('G5_MYSQL_PASSWORD', 'mekeng1!');
define('G5_MYSQL_DB', 'mek_kr');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '4a5d4dddaa0658e9a9f0e4c96dc1721e'); // 토큰 암호화에 사용할 키
...
// 품질 검사표 시스템 테이블
$g5['quality_template_table'] = G5_TABLE_PREFIX.'quality_template'; // 검사표 템플릿 테이블
$g5['quality_item_table'] = G5_TABLE_PREFIX.'quality_item'; // 검사 항목 테이블
$g5['quality_result_table'] = G5_TABLE_PREFIX.'quality_result'; // 검사 결과 테이블
$g5['quality_result_detail_table'] = G5_TABLE_PREFIX.'quality_result_detail'; // 검사 결과 상세 테이블
$g5['quality_photo_table'] = G5_TABLE_PREFIX.'quality_photo'; // 검사 사진 테이블
$g5['quality_approval_table'] = G5_TABLE_PREFIX.'quality_approval'; // 결제 이력 테이블
