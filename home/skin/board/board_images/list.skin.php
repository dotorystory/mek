          ...
          <ul class="btn_bo_user">
          	...
          	<li>
  		        ...
  		        <ul class="more_opt is_list_btn">
  		            ...
  		            <li><button type="submit" name="btn_submit" value="선택이동" onclick="document.pressed=this.value"><i class="fa fa-play" aria-hidden="true"></i> 선택이동</button></li>
  		        </ul>
  		        <?php } ?>
          	</li>
          	<?php }  ?>
            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
                ...
                <div class="bo_tit">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="listSbjA">
						...
						if ($list[$i]['icon_link']) echo ' <b>링크 있음</b>'; else echo '<b>링크 없음</b>';
						?>
                    <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><span class="cnt_cmt">+ <?php echo $list[$i]['wr_comment']; ?></span><span class="sound_only">개</span><?php } ?>
                    </a>
					<em class="listCont"><i class="fa fa-clock-o" aria-hidden="true"></i> 등록 [ <?php echo date("20y-m-d H:i", strtotime($list[$i]['wr_datetime'])) ?> ]</em>
					<em class="listCont"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo cut_str(strip_tags($list[$i][wr_content]),160," . . . ") ?></em>
                </div>
