...
<div id="bo_gall" style="width:<?php echo $width; ?>" class="sub-container">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <li>
                <button type="button" class="btn_bo_sch btn_b01 btn" title="게시판 검색"><i class="ri-search-line"></i> <span class="sound_only">게시판 검색</span></button>
            </li>
...
;
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                <?php if ($list[$i]['wr_6']) { ?>
                  <div class="new_box"><img src="<?=G5_IMG_URL?>/icon_new2.png" /></div>
                  <?php } ?>
                ...
                <div class="gall_con">
                    <div class="gall_img" style="<?php if ($board['bo_gallery_height'] > 0) echo 'height:'.$board['bo_gallery_height'].'px;max-height:'.$board['bo_gallery_height'].'px'; ?>">
                      ...
                      if ($list[$i]['is_notice']) // 공지사항
                        echo '<strong class="notice_icon">ⓘ<span class="sound_only">공지</span></strong>';
                    ...
                    <div class="gall_text_href">
                      <div class="tit">
                        <a href="<?php echo $list[$i]['href'] ?>">
                        <?php echo _($list[$i]['subject']) ?><br>
                        <?php echo _($list[$i]['wr_7']) ?>
