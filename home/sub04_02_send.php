...
if(isset($_POST['email'])) {
  ...
  $email_message .= "APC 적용 여부 : ".(!empty($apc) ? clean_string($apc) : '없음')."<br><br>"; //선택항목
  $email_message .= "라인 상태 : ".(!empty($lineStatus) ? clean_string($lineStatus) : '없음')."<br><br>"; //선택항목
