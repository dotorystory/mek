...
if ($board['bo_use_category']) {
    ...
    $category_href .= $mc_add_query; // 카테고리 링크에 mc 데이타 유지
...
if ($member['mb_level'] >= $board['bo_write_level']) {
    $write_href = './write.php?bo_table='.$bo_table.$mc_add_query;
}
