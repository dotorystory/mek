...
<div id="popup_layer" class="popup_layer">
    <div class="popup_content">
        ...
        <div class="popup_image_container">
            <img src="<?php echo G5_IMG_URL; ?>/popup.png" alt="팝업 이미지" class="popup_image">
        </div>
        
        <div class="popup_footer">
            <div class="popup_checkbox_wrap">
                <input type="checkbox" id="popup_close_today" class="popup_checkbox">
                <label for="popup_close_today" class="popup_checkbox_label">오늘 하루 열지 않기</label>
            </div>
            <div class="popup_buttons">
                <button type="button" class="popup_close_btn" onclick="closePopupWithOption()">닫기</button>
            </div>
        </div>
    </div>
</div>
