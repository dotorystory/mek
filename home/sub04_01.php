        ...
        <form name="contactform" method="post" action="/home/sub04_01_send.php" enctype="multipart/form-data" class="fields">
          <ul>
            ...
            <li id="equipment_area">
              ...
              <div class="desc flex ">
                <div>
                  <input name="group[]" type="checkbox" id="surface" class="input full check" value="표면결함검사기">
                  <p>표면결함검사기</p>
                </div>
                <div>
                  <input name="group[]" type="checkbox" id="webcleaner" class="input full check" value="웹크리너">
                  <p>웹크리너</p>
                </div>
                <div>
                  <input name="group[]" type="checkbox" id="pinning" class="input full check"  value="피닝시스템">
                  <p>피닝시스템</p>
                </div>
                <div>
                  <input name="group[]" type="checkbox" id="etc_chk" class="input full check"  value="기타(직접입력)">
                  <p>기타 (직접입력)</p>
