    ...
    <div class="footer_wrap">
        ...
        <div class="footer_info">
          <address>
            <ul>
              ...
              <li>CEO : <?php echo $default['de_admin_company_owner']; ?></li>
              <li>ADDRESS : <?php echo $default['de_admin_company_addr']; ?></li>
      ...
      <div class="footer_link">
        <ul class="footer_link_list">
          <li><a href="https://blog.naver.com/mekeng" target="_blank"><img src="/public/img/icon_naver_blog.png" alt="MEK的Naver博客链接图标"></a></li>
          <li><a href="https://www.youtube.com/@mekeng_com" target="_blank"><img src="/public/img/icon_youtube.png" alt="MEK的YouTube链接图标"></a></li>
          <li class="ft_global">
        ...
        <a href="<?php echo G5_BBS_URL?>/board.php?bo_table=news_cn&wr_id=1" class="pt_pri">隐私政策</a>
      </div>
    </div>
  </div>
</footer>
