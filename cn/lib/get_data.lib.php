...
function get_board_sfl_select_options($sfl){
    ...
    $str = '';
    $str .= '<option value="wr_subject" '.get_selected($sfl, 'wr_subject', true).'>标题</option>';
    $str .= '<option value="wr_content" '.get_selected($sfl, 'wr_content').'>内容</option>';
    $str .= '<option value="wr_subject||wr_content" '.get_selected($sfl, 'wr_subject||wr_content').'>标题+内容</option>';
    if ( $is_admin ){
        $str .= '<option value="mb_id,1" '.get_selected($sfl, 'mb_id,1').'>会员ID</option>';
        $str .= '<option value="mb_id,0" '.get_selected($sfl, 'mb_id,0').'>会员ID(co)</option>';
    }
    $str .= '<option value="wr_name,1" '.get_selected($sfl, 'wr_name,1').'>作者</option>';
    $str .= '<option value="wr_name,0" '.get_selected($sfl, 'wr_name,0').'>作者(co)</option>';
