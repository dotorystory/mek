...
<div id="bo_gall" style="width:<?php echo $width; ?>" class="sub-container">
  ...
  <span>总共 <?php echo number_format($total_count) ?> 项</span>
  <?php echo $page ?> 页
</div>
        ...
        <ul class="btn_bo_user">
            ...
            <li>
                <button type="button" class="btn_bo_sch btn_b01 btn" title="论坛搜索"><i class="ri-search-line"></i> <span class="sound_only">论坛搜索</span></button>
            </li>
            ...
            <li>
                <button type="button" class="btn_more_opt is_list_btn btn_b01 btn" title="게시판 리스트 옵션"><i class="ri-menu-line"></i><span class="sound_only">게시판 리스트 옵션</span></button>
                <?php if ($is_checkbox) { ?>
...
;
    ...
    <ul id="gall_ul" class="gall_row">
                ...
                <div class="gall_con">
                    <div class="gall_img" style="<?php if ($board['bo_gallery_height'] > 0) echo 'height:'.$board['bo_gallery_height'].'px;max-height:'.$board['bo_gallery_height'].'px'; ?>">
                      ...
                      if ($list[$i]['is_notice']) // 公告
                        echo '<strong class="notice_icon">ⓘ<span class="sound_only">公告</span></strong>';
        ...
        <?php } ?>
        <?php if (count($list) == 0) { echo "<li class=\"empty_list\">没有注册的产品。</li>"; } ?>
    </ul>
    ...
    <fieldset class="bo_sch">
        ...
        <form name="fsearch" method="get">
            ...
            <label for="stx" class="sound_only">搜索词<strong class="sound_only"> 必填</strong></label>
            <div class="sch_bar">
                <input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="sch_input" size="25" maxlength="20" placeholder="请输入搜索词">
                <button type="submit" value="搜索" class="sch_btn"><i class="fa fa-search" aria-hidden="true"></i><span class="sound_only">搜索</span></button>
            </div>
            <button type="button" class="bo_sch_cls"><i class="fa fa-times" aria-hidden="true"></i><span class="sound_only">关闭</span></button>
        </form>
    </fieldset>
