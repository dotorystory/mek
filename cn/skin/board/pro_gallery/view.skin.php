      ...
      const callback = function(mutationsList, observer) {
          for(let mutation of mutationsList) {
              if (mutation.type === 'childList') {
                  let mcViewElement = document.querySelector(".mc-view-pro_cn");
                  if(mcViewElement) {
...
<!--3d 이미지 출력 -->
    ...
    <div id="softwear" class="sub-container">
      ...
      <div class="view_list_wrap view_list_wrap01">
        <h5>MEK程序的特点</h5>
        <ul>
          <li><img src="<?=G5_URL?>/img/vi_img02.png"><span>• 用户友好型配置 - 直观界面</span></li>
          <li><img src="<?=G5_URL?>/img/vi_img03.png"><span>• 可选择语言 - 韩语，英语，中文，日语</span></li>
          <li><img src="<?=G5_URL?>/img/vi_img04.png"><span>• 用户HMI和测量数据通信(选配)</span></li>
          <li><img src="<?=G5_URL?>/img/vi_img05.png"><span>• 可根据用户要求定制 </span></li>
        </ul>
      </div>
  ...
  <tbody>
      ...
      <div id="apc" class="sub-container">
        ...
        <div class="view_list_wrap view_list_wrap04">
          ...
          <ul>
            <li>• 优化的厚度控制算法</li>
            <li>• 快速厚度控制</li>
            <li>• Auto Mapping: 中心螺栓标准</li>
            <li>• 光滑的轧辊外观</li>
            <li>• 自动调整控制增益在数微米内</li>
            <li>• 模具螺栓温度反馈控制（可选）</li>
            <li>• MD (Machine Direction) 控制选项（可选）</li>
          </ul>
        </div>
        <div class="view_list_wrap view_list_wrap05">
          ...
          <div class="apc_grid">
            ...
            <div class="apc_arrow">
              <p> <img src="<?=G5_URL?>/img/pro_arrow.png" alt="下箭头"> </p>
            </div>
            <div class="apc_void">
    ...
    <div class="control sub-container">
    	<div class="khwrap">
    		...
    		<div class="button fr">
          <a href="<?php echo $list_href ?>" class="bt bt_list"><i class="ri-menu-line"></i> <?php echo _("列表") ?></a>
