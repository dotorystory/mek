...
<div id="sub_wrap" class="sub04_01">
  <section class="sub-section section01 sub-container" data-aos="fade-up"  data-aos-duration="2000">
    ...
    <div class="send_box02">
      <fieldset>
        <form name="contactform" method="post" action="/cn/sub04_01_send.php" enctype="multipart/form-data" class="fields">
          <ul>
            <!-- <h4>기본정보</h4> -->
            <li>
            ...
            <li id="equipment_area">
              ...
              <div class="desc flex ">
                <div>
                  <input name="group[]" type="checkbox" id="surface" class="input full check" value="表面缺陷检测机">
                  <p>表面缺陷检测机</p>
                </div>
                <div>
                  <input name="group[]" type="checkbox" id="webcleaner" class="input full check" value="网页清洁器">
                  <p>网页清洁器</p>
                </div>
                <div>
                  <input name="group[]" type="checkbox" id="pinning" class="input full check"  value="固定系统">
                  <p>固定系统</p>
                </div>
                <div>
                  <input name="group[]" type="checkbox" id="etc_chk" class="input full check"  value="其他(自行输入)">
                  <p>其他 (自行输入)</p>
          ...
          <li>
            ...
            <li>
              <label for="area" class="lbl">适用范围</label>
              <div class="desc">
                <input name="area" type="text" class="input full" id="area" maxlength="80" placeholder="单面/双面">
              </div>
            </li>
              <li>
                <label for="thickness" class="lbl">厚度</label>
                <div class="desc">
                  <input name="thickness" type="text" class="input full" id="thickness" maxlength="80" >
                </div>
              </li>
              <li>
                <label for="width" class="lbl">宽度</label>
                <div class="desc">
              ...
              <li>
                <label for="requests" class="lbl">要求去除和检测对象</label>
                <div class="desc">
                  <input name="requests" type="text" class="input full" id="requests" maxlength="80" placeholder="例如：硅胶，头发">
                </div>
              </li>
            </div>
