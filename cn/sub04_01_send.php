...
if(isset($_POST['email'])) {
  ...
  $email_message .= "适用范围 : ".clean_string($area)."<br><br>";
  $email_message .= "厚度 : ".clean_string($thickness)."<br><br>";
  $email_message .= "宽度 : ".clean_string($width)."<br><br>";
  $email_message .= "线速度 : ".clean_string($lineSpeed)."<br><br>";
  $email_message .= "要求去除和检测对象 : ".clean_string($requests)."<br><br>";
