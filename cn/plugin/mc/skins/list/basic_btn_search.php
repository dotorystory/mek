...
<div class="mc-control-row" style="border:0" >
    ...
    <div class="mc-checked-list">
        <button type="button" class="mc-btn-submit" onclick="mc_search(this.form);this.form.submit()">搜索</button>
        ...
        <?php endforeach; ?>
        <span class="mc-checked-reset" onclick="mc.resetCheckedItem()">搜索重置</span>
    </div>
</div>
<script>
