...
if(isset($_POST['simple_email'])) {
    ...
    $email_subject = "[简单咨询] 来自".$name."的咨询";
    ...
    $email_message = "公司名 : ".clean_string($name)."<br><br>";
    $email_message .= "邮箱 : ".clean_string($email_from)."<br><br>";
    $email_message .= "电话 : ".clean_string($phone)."<br><br>";
    $email_message .= "留言 : ".clean_string(nl2br($message))."<br><br>";
...
<div id="simple_inquiry_layer" class="simple_inquiry_layer">
    <div class="simple_inquiry_content">
        ...
        <form name="simple_inquiry_form" method="post" action="/cn/simple_inquiry.php" class="simple_inquiry_form">
            <div class="simple_inquiry_fields">
                <div class="field_group">
                    <label for="simple_name" class="required">公司名</label>
                    <input type="text" name="simple_name" id="simple_name" required placeholder="请输入您的公司名（仅供参考，保密）">
                </div>
                
                <div class="field_group">
                    <label for="simple_email" class="required">邮箱</label>
                    <input type="email" name="simple_email" id="simple_email" required placeholder="请输入您可接收的邮箱地址">
                </div>
                
                <div class="field_group">
                    <label for="simple_phone">电话</label>
                    <input type="tel" name="simple_phone" id="simple_phone" placeholder="请输入负责人手机/电话号码等">
                </div>
                
                <div class="field_group">
                    <label for="simple_message" class="required">留言</label>
                    <textarea name="simple_message" id="simple_message" required placeholder="请输入您的咨询内容（最多500字）" rows="2"></textarea>
                </div>
                ...
                <div class="field_group">
                    <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap;">
                        <div style="display: flex; align-items: center;">
                            ...
                            <label for="simple_agree" style="margin: 0; display: inline;">同意'个人信息收集·利用'。</label>
                        </div>
                        <a href="javascript:void(0);" onclick="togglePrivacyContent()" style="color: #1a4691; text-decoration: underline; font-size: 13px; margin-left: 10px; cursor: pointer;">个人信息收集·利用</a>
                    </div>
            ...
            <div class="simple_inquiry_footer">
                <button type="submit" class="simple_inquiry_submit">发送咨询</button>
            </div>
        </form>
    </div>
</div>
