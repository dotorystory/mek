<?php
// 일본 전시회 카탈로그 QR 코드 리다이렉트
// UTM 파라미터를 GET 방식으로 받아 변수로 저장
$utm_source = isset($_GET['utm_source']) ? $_GET['utm_source'] : "jp_catalog_qr";
$utm_medium = isset($_GET['utm_medium']) ? $_GET['utm_medium'] : "qr_code";
$utm_campaign = isset($_GET['utm_campaign']) ? $_GET['utm_campaign'] : "japan_exhibition";
...
// 국가별 리다이렉트 경로 설정
$langPath = "/jp"; // 기본값: 일본 (전시회가 일본에서 열리므로)
